...
public class EmpController {
	...
	// 관리자 - 사원등록 - form
	@GetMapping("cust/manager/empInsert")
	...
	// 관리자 - 사원등록 - process
	@PostMapping("cust/manager/empInsert")
	...
	// 관리자 - 사원수정 - form
	@GetMapping("cust/manager/empUpdate")
	...
	// 관리자 - 사원수정 - process
	@PostMapping("cust/manager/empUpdate")
	...
	// 관리자 - 사원목록
	@GetMapping("cust/manager/empList")
